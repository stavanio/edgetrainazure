...
Rendered mockups of all three are in the [README](../README.md#4-dashboards),
generated by [`observability/render_mockups.py`](../observability/render_mockups.py)
from the same panel set. They carry synthetic data and are stamped as mockups:
no fleet has reported into these.
